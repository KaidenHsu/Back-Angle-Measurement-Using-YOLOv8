...
This is an implementation of the back angle measurement model in our ***IJETI, 2026*** paper ***"[Real-Time Video-Based Measurement of Back Angles Using YOLOv8 and Edge Detection for Strength Training](https://ojs.imeti.org/index.php/IJETI/issue/view/86)"***
