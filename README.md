...
This is an implementation of the back angle measurement model in the paper. This model takes images as well as videos as input, and measure the back angle in real time without hassle!
